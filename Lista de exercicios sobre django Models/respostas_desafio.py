...
People.objects.filter(nome__startswith="Ber")
People.objects.filter(tipo_sanguineo__in=['A', 'AB+'])
values = People.objects.values() #valores em formato dicionario
values = People.objects.values('nome','cpf','rg','celular')
Para ver os metodos de objects -> dir(People.objects)
"""
